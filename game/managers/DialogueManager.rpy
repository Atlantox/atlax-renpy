    ...
    class DialogueManager:
        ...
        def HandleDialogueEnd(self):
            ...
            if self.terminateMethod.lower() == 'decision':
                ...
                backgroundManager.TurnScreenToBlack(5)
        ...
        def ReturnToMainMenu(self):
            backgroundManager.TurnScreenToBlack(5)
            backgroundManager.ShowMainMenuBackground(5)
        ...
        def NovelBeginWithCustomScript(self, nextDialogue):
            self.terminateData = [
                {
                    'key': 'begin_custom_script',
